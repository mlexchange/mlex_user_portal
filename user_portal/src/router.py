...
def display_page(pathname):
    ...
    if pathname == "/mlex_content":
        return html.Iframe(src="https://content.mlexchangebeta.als.lbl.gov", style={"height": "1067px", "width": "100%"}), loggedin_layout
    if pathname == "/mlex_search":
        return html.Iframe(src="https://search.mlexchangebeta.als.lbl.gov", style={"height": "1000px", "width": "100%"}), loggedin_layout
    if pathname == "/mlex_compute":
        return html.Iframe(src="https://job.mlexchangebeta.als.lbl.gov", style={"height": "1000px", "width": "100%"}), loggedin_layout
    if pathname == "/mlex_logout":
        return html.Img(src="assets/mlex_logout.png", style={"height": "100%", "width": "100%"}), loggedin_layout
